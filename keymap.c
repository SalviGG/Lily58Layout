...
[_LOWER] = LAYOUT( \
  ...
  KC_NO, KC_NO, KC_NO,   KC_AMPR, KC_LPRN,  KC_RPRN,                   KC_LBRC, KC_RBRC, KC_PIPE, KC_NO, LSFT(KC_SCLN), LSFT(KC_QUOT), \
  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LSFT(KC_LBRC), RSFT_T(KC_RBRC), KC_NO, KC_NO, KC_NO, KC_NO, LSFT(KC_SLSH), KC_NO, \
